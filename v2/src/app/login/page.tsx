...
function LoginContent() {
  ...
  useEffect(() => {
    ...
    if (error) {
      ...
      setLoginError(messages[error] || messages.Default);
    }
  }, [searchParams]);
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-gray-900">All-Platform-Post</h1>
          <p className="text-gray-600 mt-2">Multi-platform social media posting</p>
        </div>
